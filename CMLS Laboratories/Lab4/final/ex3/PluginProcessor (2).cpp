...
void OscillatorAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    //******************************************************************************
    // 3) Initialize the values of the three variables freq, amplitude and phase
    freq = 440.0;
    amplitude = 0.0;
    phase = 0.0;
    //******************************************************************************
...
void OscillatorAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //********************************************************************************************//
    // 4) implement the actual oscillator
    ...
    {   
        ...
        phase +=  (float) ( M_PI * 2. *( ((double) freq_now  / (double) SAMPLE_RATE)));
...
void OscillatorAudioProcessor::setFreq(float val){
    freq = val;
}

void OscillatorAudioProcessor::setAmplitude(float val){
    amplitude = val;
}
