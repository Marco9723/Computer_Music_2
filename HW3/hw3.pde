...
void setup()
{
  ...
  background(51);
  textSize(20);
  text("Choose an image:", 910, 30);
  text("Root note:", 910, 130);
  text("Current chord:", 910, 230);
  //------------------------
  text("ADSR parameters:", 910, 330);
  text("LPF", 910, 480);
  text("Chord change slide", 910+150, 480);
  ...
  //adding knobs
  addKnob("peak", ADSR_x, 370, 1, 1);
  addKnob("att", ADSR_x+ADSR_dist, 370, 3, 0.5);
  addKnob("dec", ADSR_x+ADSR_dist*2, 370, 5, 0);
  addKnob("sus", ADSR_x+ADSR_dist*3, 370, 1, 1);
  addKnob("rel", ADSR_x+ADSR_dist*4, 370, 5, 0.5);
  addKnob("freqCut", ADSR_x, 500, 10000, 5000);
  addKnob("slideDur", ADSR_x+200, 500, 3, 0.3);
...
void draw()
{
  ...
  //colour selected
  fill(c);
  rect(winWidth-80-30, 30, 100, 100);
  }
}
